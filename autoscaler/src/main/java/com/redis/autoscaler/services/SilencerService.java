...
public class SilencerService {
    ...
    @SneakyThrows
    public void silenceAlert(String instance, RuleType ruleType, int durationMin){
         SilenceRequest silenceRequest = new SilenceRequest(instance, ruleType, durationMin);
